      ...
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <h1 className="text-lg font-bold text-slate-900">Dashboard Master</h1>
                <span className="rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-emerald-700">
                  Login sebagai {userName || "Admin"}
                </span>
              </div>
              <p className="text-xs text-slate-500">Terakhir sinkron: {lastSyncLabel}</p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={() => navigate("/")}
              className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-red-500 to-orange-500 px-3 py-2 text-xs font-semibold text-white shadow-md shadow-red-500/30 transition hover:brightness-110"
            >
        ...
        <aside className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-xl backdrop-blur">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold text-slate-900">WashFlow</h1>
            </div>
          </div>
          ...
          <div className="mt-6 space-y-2">
            {["layanan", "produk"].map((tab) => (
              ...
              >
                <span>{tab === "layanan" ? "Layanan" : "Produk"}</span>
                <span className="text-xs text-slate-500">{tab === "layanan" ? `${layanan.length}` : `${produk.length}`}</span>
              </button>
            ))}
          </div>
        </aside>
                        ...
                        return (
                          <div
                            ...
                            className={`rounded-xl border ${
                              editing ? "border-blue-200 bg-blue-50/50" : "border-slate-200 bg-white"
